...
Label(window, text="第1行，第2列", font=('Arial bold', 20),
      bg="red", fg="white").grid(row=1, column=2, padx=5, pady=5)
Label(window, text="第1行，第3列", font=('Arial bold', 20),
      bg="orange", fg="white").grid(row=1, column=3, padx=5, pady=5)

Label(window, text="第2行，第0列", font=('Arial bold', 20),
      bg="blue", fg="white").grid(row=2, column=0, padx=5, pady=5)
Label(window, text="第2行，第1列", font=('Arial bold', 20),
      bg="red", fg="white").grid(row=2, column=1, padx=5, pady=5)
Label(window, text="第2行，第2列", font=('Arial bold', 20),
      bg="orange", fg="white").grid(row=2, column=2, padx=5, pady=5)
