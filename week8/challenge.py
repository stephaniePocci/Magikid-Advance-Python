...
1. create a countdown function
2. create a checkbox with 4 answers (green, yellow, red, blue)
3. create a label that says what they need to click on
4. create a submit button
5. change the label so that it randomly picks a combination of colors
"""
